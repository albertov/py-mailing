Ext.define('Mailing.store.ItemTreeStore', {
    extend: 'Ext.data.TreeStore',
    requires: [
        'Mailing.model.ItemNode'
    ],
    model: 'Mailing.model.ItemNode',
    ...
    _updateCategories: function() {
        function copy_node(src, dst) {
            ...
            src.eachChild(function(sNode) {
                ...
                dNode = new Mailing.model.ItemNode(data);
    ...
    _updateItems: function() {
        ...
        this.items.each(function(item) {
            ...
            var newItem = new Mailing.model.ItemNode(data),
